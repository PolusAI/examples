...
with t2:
    ...
    **EpiCenter for Disease Dynamics** | School of Veterinary Medicine - UC Davis
    """)
    st.write("This example was adapted from the original [here](https://github.com/PanditPranav/SVM_COVID_tracking/tree/main).")
